...
def jogar():
    ...
    letras_acertadas = inicializa_preenchimento(palavra_secreta)
    print(f"Vamos lá, a palavra secretra é: {letras_acertadas}")
...
def inicializa_preenchimento(palavra_secreta):
